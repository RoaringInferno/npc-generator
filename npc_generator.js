        ...
        records.push(
            {
                ...
                Kindness: kindness,
                Strength: (ability_scores[0]).toString() + " (" + getModifierForDisplay(ability_scores[0]) + ")",
                Dexterity: (ability_scores[1]).toString() + " (" + getModifierForDisplay(ability_scores[1]) + ")",
                Constitution: (ability_scores[2]).toString() + " (" + getModifierForDisplay(ability_scores[2]) + ")",
                Intelligence: (ability_scores[3]).toString() + " (" + getModifierForDisplay(ability_scores[3]) + ")",
                Wisdom: (ability_scores[4]).toString() + " (" + getModifierForDisplay(ability_scores[4]) + ")",
                Charisma: (ability_scores[5]).toString() + " (" + getModifierForDisplay(ability_scores[5]) + ")",
